...
class BootstrapReactView extends ReactComponentBase {
  ...
  render () {
    let {foldsec1, foldsec2, foldsec3} = this.state
    return (
      <div className='bootstrapsec'>
        <h3 style={{paddingLeft: '20px'}}>基于：react-bootstrap</h3>
        <div>
          <fieldset>
            <legend onClick={e=>this.changeFold(1)}>按钮<span className={classNames('caret', {'fold':foldsec1})}></span></legend>
            <div className={classNames({'hide':foldsec1})}>
              ...
              <ButtonToolbar>
                <ButtonGroup bsSize='lg'>
                  ...
                  >
                    <MenuItem eventKey='1' href='#/cn' target='_blank'>中文</MenuItem>
          ...
          <fieldset>
            <legend onClick={e=>this.changeFold(2)}>checkbox / radio <span className={classNames('caret', {'fold':foldsec2})}></span></legend>
          ...
          <fieldset>
            <legend onClick={e=>this.changeFold(3)}>Menuitem <span className={classNames('caret', {'fold':foldsec3})}></span></legend>
            <Clearfix className={classNames('foldsec3', {'hide':foldsec3})}>
              <ul className='dropdown-menu open'>
                ...
                <MenuItem title='我是一个title' eventKey={100} onSelect={ekey=>dialog.alert(ekey)} >带title且可以点击</MenuItem>
              </ul>
            </Clearfix>
          </fieldset>
        </div>
