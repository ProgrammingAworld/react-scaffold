...
// artDialog - 默认配置
  define('dialog-config', {
    ...
    backdropOpacity: 0.2,
        ...
        // 消息内容
    content: '<span class="artui-dialog-loading"><i class="fa fa-spinner fa-pulse fa-3x fa-fw"></i><span class="sr-only">Loading...</span></span>',
    ...
    innerHTML: '<div i="dialog" class="artui-dialog">' +
      ...
      button: function (args) {
        ...
        if (typeof args === 'string') {
          ...
          $.each(args, function (i, val) {
            ...
            var style = ''
            var klass = id == 'ok' || val.autofocus ? 'btn btn-default btn-primary' : 'btn btn-default'
            var btnIndex = i
            klass = val.disabled ? klass + ' disabled' : klass
